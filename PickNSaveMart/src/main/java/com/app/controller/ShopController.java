...
public class ShopController {
	...
	public ResponseEntity<?> addNewshops(@RequestParam String newShop,@RequestParam(required = false) MultipartFile image ){
	  ...
	  @GetMapping("/vist/{Sid}") public ResponseEntity<?> getShopById(@PathVariable
	  int Sid){ return ResponseEntity.ok(shopSer.getShopBYSid(Sid)); }
	...
	/*
	 * @PutMapping("/add-stokes") public ResponseEntity<?>
	 * addNewProductStocks(@RequestBody Product newStokes){
	 * System.out.println(newStokes); return
	 * ResponseEntity.ok(productService.addNewStokesByPid(newStokes.getP_Id(),
	 * newStokes.getStocks())); }
	 */
	...
	/*
	 * @GetMapping("/countShop") public ResponseEntity<?> countShop(){ return
	 * ResponseEntity.ok(shopSer.countNumberOfShop()); }
	 */
