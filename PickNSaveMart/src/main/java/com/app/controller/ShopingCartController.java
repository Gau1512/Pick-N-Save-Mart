...
public class ShopingCartController {
	...
	/*
	 * @GetMapping("/paymentCancelation") public ResponseEntity<?>
	 * paymentCancelation(){ Integer
	 * userId=Integer.parseInt(SecurityContextHolder.getContext().getAuthentication(
	 * ).getName()); return
	 * ResponseEntity.ok(shopcartService.payMentCancelation(userId)); }
	 */
