...
public class UserContoller {
	...
	/*
	 * @GetMapping("/customers") public ResponseEntity<?> getAllCustomers() {
	 * 
	 * return new ResponseEntity<>(userService.getUsersByRole(Role.CUSTOMER),
	 * HttpStatus.OK); }
	 * 
	 * @GetMapping("/vendor") public ResponseEntity<?> getAllBakers() {
	 * 
	 * return new ResponseEntity<>(userService.getUsersByRole(Role.VENDOR),
	 * HttpStatus.OK); }
	 */
