...
public class ShopServiceImpl implements IShopService {
	...
	/*
	 * @Override public String deleteProduct(int P_id) { // TODO Auto-generated
	 * method stub Product p=product.findById(P_id); Shop s=product.delete(P_id);
	 * shopDao.findById(s.getS_Id()).get().getS_products().remove(p); return
	 * "product deleted successfully"; }
	 */

	/*
	 * @Override public String editProduct(int p_id,Product editProduct) { // TODO
	 * Auto-generated method stub return
	 * "product edit successfully with details "+product.editProduct(p_id,
	 * editProduct); }
	 * 
	 * 
	 * @Override public void checkOut() { // Optional<ShopingCart> shopingProd=
	 * cartDao.findById(getCartId());
	 * 
	 * 
	 * }
	 */
	...
	/*
	 * @Override public int countNumberOfShop() {
	 * System.out.println("inside count"+shopDao.count()); return (int)
	 * shopDao.count(); }
	 */
